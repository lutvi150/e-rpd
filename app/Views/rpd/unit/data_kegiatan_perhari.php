                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <a href="/unit/tambah-penarikan-mingguan/<?=$lembaga->id_lembaga . "/" . $kegiatan->id_kegiatan . "/" . $rincian_kegiatan->id_rincian?>"
                                        ...
                                        <a class="btn btn-success btn-xs" href="/unit/tambah-penarikan-harian/<?=$lembaga->id_lembaga . "/" . $kegiatan->id_kegiatan . "/" . $rincian_kegiatan->id_rincian . "/" . $month_number?>"><i class="fa fa-hand-o-up" aria-hidden="true"></i> Penarikan Harian</a>
...
<script>
    ...
    update_total = (date) => {
        ...
        for (let index = 1; index <= day; index++) {
            pagu=parseInt($(".date_" + index).val());
            if ($(".date_" + index)[0]) {
                array_penarikan.push({date:index,pagu:pagu})
                };
            }
            sessionStorage.setItem('rincian_perhari',JSON.stringify(array_penarikan));
